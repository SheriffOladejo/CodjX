...
class TerminalInstance: NSObject, WKScriptMessageHandler, WKNavigationDelegate {
    ...
    func userContentController(
        ...
        case "Return":
            ...
            case "help":
                let messages = [
                    "CodjX Suite Writer's emulated terminal is built on top of Nicolas Holzschuch (GitHub: holzchu)'s ios_system. It has many Unix commands: ls, pwd, tar, mkdir, grep... You can redirect command output to a file with \">\" and pipe commands with \"|\". In addition, there is support for Node.js and Python runtime.",
                    "\n",
