...
generally represented as a folder in the XCodjX Suite Writerlication.  PBXGroups can
...
XCodjX Suite Writerlication.  Files used as input to these phases (for example, source
...
compiler flags for each.  These flags can be modified in the XCodjX Suite Writerlciation
in the "Build" tab of a File Info window.

When a project is open in the XCodjX Suite Writerlication, Xcode will rewrite it.  As
such, this module is careful to adhere to the formatting used by Xcode, to
avoid insignificant changes appearing in the file when it is used in the
XCodjX Suite Writerlication.  This will keep version control repositories happy, and
